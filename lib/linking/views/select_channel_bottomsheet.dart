...
class SelectChannelBottomsheet extends StatefulWidget {
  const SelectChannelBottomsheet({super.key});

  @override
  State<SelectChannelBottomsheet> createState() => _InitialLinkingViewState();
}

class _InitialLinkingViewState extends State<SelectChannelBottomsheet> {
  @override
