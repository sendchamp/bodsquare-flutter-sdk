...
part of 'add_social_media_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddSocialMediaResponse _$AddSocialMediaResponseFromJson(
    ...
    AddSocialMediaResponse(
      ...
      data: json['data'] == null
          ? null
          : AddSocialMediaData.fromJson(json['data'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$AddSocialMediaResponseToJson(
        AddSocialMediaResponse instance) =>
    <String, dynamic>{
...
AddSocialMediaData _$AddSocialMediaDataFromJson(Map<String, dynamic> json) =>
    AddSocialMediaData(
...
Map<String, dynamic> _$AddSocialMediaDataToJson(AddSocialMediaData instance) =>
    <String, dynamic>{
